...
export default function Home() {
  return (
    <>
      ...
      {/*
      <div className="px-12 gap-8 flex flex-col lg:grid lg:grid-cols-2 pb-40 lg:items-center"
        <InfoCard
          title="Introduzione al Machine Learning"
          author="Federico Bianchi"
          desc="Il Machine Learning rappresenta una branca della ricerca sulle intelligenze artificiali (AI). L’obiettivo del machine learning è comprendere la struttura e far combaciare i dati in un modello che possa essere comprensibile e utilizzato dalle persone."
          to="/introduzione"
          img="https://humanativaspa.it/wp-content/uploads/2021/05/HN_machine_learning_ist.jpg"
        />
        <InfoCard
          title="Metodi di Machine Learning"
          author="Gabriele Petrella"
          desc="L'apprendimento supervisionato, noto anche come machine learning supervisionato, è una sottocategoria di machine learning e AI."
          to="/metodi"
          img="https://www.lum.it/wp-content/uploads/2023/10/machine.jpg"
        />
        <InfoCard
          title="Machine Learning, deep learning and neural networks"
          author="Leonardo Giardino"
          desc="Machine Learning, deep learning, and neural networks are integral components of modern artificial intelligence, each playing a crucial role in understanding and processing complex data patterns."
          to="/differenze"
          img="https://miro.medium.com/v2/resize:fit:1400/1*c_fiB-YgbnMl6nntYGBMHQ.jpeg"
        />
        <InfoCard
          ...
          desc=""
          to="/applicazioni"
          img="https://www.ibm.com/content/dam/connectedassets-adobe-cms/worldwide-content/stock-assets/getty/image/photography/b5/37/126_data_brain.component.xl.ts=1703181487291.jpg/content/adobe-cms/it/it/topics/machine-learning-algorithms/_jcr_content/root/leadspace"
        />
      </div>*/}
    </>
  );
